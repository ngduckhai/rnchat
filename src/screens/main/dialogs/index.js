      ...
      headerTitle: (
        <Text
          style={[
            ...
            Platform.OS === 'android' ? {paddingLeft: 13} : {paddingLeft: 0},
          ]}>
      ...
      <View style={styles.container}>
        ...
        {isLoader ? (
          ...
          <View
            ...
            <Text style={{fontSize: 19}}>Không có cuộc trò chuyện</Text>
          </View>
        ) : (
          <FlatList
            data={this.dialogs}
        ...
        <CreateBtn
          goToScreen={this.goToContactsScreen}
          type={BTN_TYPE.DIALOG}
        />
      </View>
    );
  }
